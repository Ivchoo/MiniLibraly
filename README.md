...
Целта на задачата е да се създаде малка система за библиотека, съставена от няколко взаимосвързани класа, чрез която се упражняват основните концепции за класове в C++, включително:
...
Параметризиран, валидация dueDate >= startDate
